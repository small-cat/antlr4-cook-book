...
void MathParser::CompileUnitContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<MathParserListener *>(listener);
...
antlrcpp::Any MathParser::CompileUnitContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<MathParserVisitor*>(visitor))
...
tree::TerminalNode* MathParser::FuncExprContext::LEFT_PAREN() {
  return getToken(MathParser::LEFT_PAREN, 0);
}
...
tree::TerminalNode* MathParser::FuncExprContext::RIGHT_PAREN() {
  return getToken(MathParser::RIGHT_PAREN, 0);
}
...
tree::TerminalNode* MathParser::FuncExprContext::COMMA() {
  return getToken(MathParser::COMMA, 0);
}
...
tree::TerminalNode* MathParser::ParenExprContext::LEFT_PAREN() {
  return getToken(MathParser::LEFT_PAREN, 0);
}
...
tree::TerminalNode* MathParser::ParenExprContext::RIGHT_PAREN() {
  return getToken(MathParser::RIGHT_PAREN, 0);
}
...
MathParser::ExprContext* MathParser::expr(int precedence) {
  ...
  try {
    ...
    switch (_input->LA(1)) {
      case MathParser::LEFT_PAREN: {
        _localctx = _tracker.createInstance<ParenExprContext>(_localctx);
        _ctx = _localctx;
        previousContext = _localctx;

        setState(8);
        match(MathParser::LEFT_PAREN);
        setState(9);
        expr(0);
        setState(10);
        match(MathParser::RIGHT_PAREN);
        break;
      }
...
std::vector<std::string> MathParser::_symbolicNames = {
  "", "ADD", "SUB", "MUL", "DIV", "LEFT_PAREN", "RIGHT_PAREN", "COMMA", 
  "ID", "NUM", "WS"
};
...
MathParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x3, 0x4, 0x4, 0x2, 0x4, 0x2, 0x4, 0x3, 0x2, 0x3, 0x4, 0x3, 0x2, 0x5, 
    0x6, 0x2, 0x2b, 0x2, 0x6, 0x3, 0x2, 0x2, 0x2, 0x4, 0x1a, 0x3, 0x2, 0x2, 
    0x2, 0x6, 0x7, 0x5, 0x4, 0x3, 0x2, 0x7, 0x8, 0x7, 0x2, 0x2, 0x3, 0x8, 
    0x3, 0x3, 0x2, 0x2, 0x2, 0x9, 0xa, 0x8, 0x3, 0x1, 0x2, 0xa, 0xb, 0x7, 
    0x7, 0x2, 0x2, 0xb, 0xc, 0x5, 0x4, 0x3, 0x2, 0xc, 0xd, 0x7, 0x8, 0x2, 
    0x2, 0xd, 0x1b, 0x3, 0x2, 0x2, 0x2, 0xe, 0xf, 0x9, 0x2, 0x2, 0x2, 0xf, 
    0x1b, 0x5, 0x4, 0x3, 0x7, 0x10, 0x11, 0x7, 0xa, 0x2, 0x2, 0x11, 0x12, 
    0x7, 0x7, 0x2, 0x2, 0x12, 0x15, 0x5, 0x4, 0x3, 0x2, 0x13, 0x14, 0x7, 
    0x9, 0x2, 0x2, 0x14, 0x16, 0x5, 0x4, 0x3, 0x2, 0x15, 0x13, 0x3, 0x2, 
    0x2, 0x2, 0x15, 0x16, 0x3, 0x2, 0x2, 0x2, 0x16, 0x17, 0x3, 0x2, 0x2, 
    0x2, 0x17, 0x18, 0x7, 0x8, 0x2, 0x2, 0x18, 0x1b, 0x3, 0x2, 0x2, 0x2, 
